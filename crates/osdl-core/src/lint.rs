...
/// Per-rule severity overrides, loaded from `.osdl-lint.toml`.
...
impl LintConfig {
    ...
    /// Load config from a `.osdl-lint.toml` file. Unknown rule ids are ignored;
