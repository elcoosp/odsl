...
//!
//! Each ODSL model becomes a schema object in the requested library, with
...
/// Map an ODSL scalar to the flavour-specific primitive expression (without
...
fn render_model(flavor: ValidatorFlavor, model: &Model, ast: &Ast) -> String {
    ...
    let header = format!(
        "// Generated by `odsl build --target {}`. Do not edit by hand.\n// Source of truth: the ODSL schema.\n{}\n",
        flavor.as_str(),
        import
    );
...
mod tests {
    ...
    fn render(flavor: ValidatorFlavor, src: &str) -> String {
        ...
        odsl_core::Validator::validate(&ast, Some(Target::Zod)).expect("validate");
