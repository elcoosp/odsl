//! # ODSL Core — the shared contract of the ODSL compiler.
//!
...
pub use errors::{CompileErrorKind, OdslError, ParseError, Span};
...
/// The conventional name of an ODSL schema file.
pub const SCHEMA_FILE: &str = "schema.odsl";
/// The conventional name of the generated lockfile.
pub const LOCKFILE: &str = "odsl.lock";
