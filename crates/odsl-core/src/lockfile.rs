//! The ODSL lockfile: a deterministic snapshot of a compiled schema.
//!
...
impl Lockfile {
    ...
    pub fn to_string_pretty(&self) -> Result<String, OdslError> {
        Ok(serde_json::to_string_pretty(self)?)
    }

    /// Parse a lockfile from JSON text.
    #[allow(clippy::should_implement_trait)]
    pub fn from_str(text: &str) -> Result<Self, OdslError> {
